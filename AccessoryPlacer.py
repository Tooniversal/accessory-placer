...
class AccessoryPlacer(ShowBase):
    ...
    def loadBackpack(self):
        ...
        self.currBackpack = loader.loadModel(modelName,okMissing=True)
    ...
    def loadHat(self):
        ...
        self.currHat = loader.loadModel(modelName, okMissing=True)
    ...
    def loadGlasses(self):
        ...
        self.currGlasses = loader.loadModel(modelName, okMissing=True)
